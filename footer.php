            ...
            <div class="col-md-3">
                ...
                <ul class="menu-list">
                    <?php if(!empty($footer[0]['contact_address'])){ ?>
                        <li><i class="fa fa-home" ></i><span>: Chandigarh University</span></li>
                    <?php } ?>
                    <?php if(!empty($footer[0]['contact_phone'])){ ?>
                        <li><i class="fa fa-phone" ></i><span>: 8360757609</span></li>
                    <?php } ?>
                    <?php if(!empty($footer[0]['contact_email'])){ ?>
                        <li><i class="fa fa-envelope" ></i><span>:gehnasachdeva1975@gmail.com</span></li>
                    <?php } ?>
                </ul>
            </div>
            <div class="col-md-12">
                <span>| Created by Gehna Sachdeva | UID :21MCI1059 | Email.id: gehnasachdeva1975@gmail.com | Ph.no :8360757609</span>
            </div>
        </div>
    </div>
</div>
